...
parser.add_argument('--data', metavar='DIR', default='/4T/ImageNetLT')
...
parser.add_argument('--mark', default='LT_X50_cls', type=str,
                    help='log dir')
best_acc = 0
...
def adjust_learning_rate(optimizer, epoch, args):
    ...
    if epoch < args.warmup_epochs:
        ...
        lr = lr * 0.5 * (1. + math.cos(
            math.pi * (epoch - args.warmup_epochs + 1) / (args.epochs - args.warmup_epochs + 1)))
